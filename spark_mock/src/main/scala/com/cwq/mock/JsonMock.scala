package com.cwq.mock

import java.util.Date

import com.alibaba.fastjson.{JSON, JSONObject}
import com.cwq.mock.util.{LogUploader, RandomNumUtil, RandomOptions}

/**
  * 模拟客户端访问服务器，并向服务器发送事件日志
  */
object JsonMock {
  ...
  val eventOpts = RandomOptions(
    ...
    ("addCart", 20), ("clickItem", 40),("coupon",40))
  ...
  def initOneStartupLog(): String = {
    ...
    val uid: String = "" + RandomNumUtil.randomInt(1, 200)
